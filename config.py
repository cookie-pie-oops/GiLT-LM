...
class TrainConfig:
    ...
    start_lr: float = 1e-7
    proposed_warmup_steps: int = 8000 # debug: 45, normal: 8000
    eta_min: float = 3e-7
...
class DebugTrainConfig:
    ...
    seed: int = 12345
    proposed_batch_size: int = 1
    num_workers: int = 0
    epochs: int = 1
    
    max_lr: float = 1.5e-4
    start_lr: float = 1e-7
    proposed_warmup_steps: int = 8000
    eta_min: float = 3e-7
    ...
    log_interval: int = 200 // gradient_accumulation_steps # debug: 1, normal: 50
    eval_interval: int = 1000 // gradient_accumulation_steps # debug: 1, normal: 250
