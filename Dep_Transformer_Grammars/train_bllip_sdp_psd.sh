...
# --model_file models/txl_pointer_psd_4_1:10.pt \
python train_sdp.py \
    --train_file  ../data_process/transition_sequence/BLLIP_LG_TRAIN_$DATASET.csv \
    --dev_file ../data_process/transition_sequence/BLLIP_LG_DEV_$DATASET.csv \
    --test_file ../data_process/transition_sequence/BLLIP_LG_TEST_$DATASET.csv \
    ...
    --log_file logs/log_sdp_pointer_$DATASET\_4_100:1.txt \
    --vocab_file ../data_process/spm_parsing/BLLIP_spm.vocab \
    --save_path models/sdp_pointer_$DATASET\_4_100:1.pt \
    --attn_mask sdp_arc \
    --sentence_level \
