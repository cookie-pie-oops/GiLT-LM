...
#SBATCH -G 1
#SBATCH --output=SG_3mixing_4_psd_large_action_num_300_5_easydepth_4096inner_2048out_multiheadforward_8head.out
...
#     --model_path models/GiLT_large_psd_4_1:0.2_3mixing_easydepth_4096inner_2048out_multiheadforward_8head.pt \
#     --beamsize 300 \
#     --scorebeamsize 20 \
