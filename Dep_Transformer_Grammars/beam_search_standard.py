...
def word_sync_beam_search(
    ...
    # init beams
        ...
        TGAgents = [[TGAgent(ranges, -1, 0) for _ in range(beam_size)] for __ in range(BATCH)]
        ...
        for terminal_cursor in range(1, SEQLEN):
            ...
            for k in range(max_action_length_per_step):
                ...
                next_scores, new_keys, new_values = model.constrained_forward_gen(new_tokens,
                                                                                ...
                                                                                62,
                                                                                -1,
                                                                                'sub+action') # batch x beam_size x vocab
...
if __name__ == "__main__":
    ...
    original_length = []
    original_seq_length = []
    checkpoint = torch.load('models/standard_rbt_1.pt')
